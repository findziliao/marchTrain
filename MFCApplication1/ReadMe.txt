...
MFCApplication1.h
    这是应用程序的主头文件。
    其中包括其他项目特定的标头（包括 Resource.h），并声明 CMFMarchTrainApp 应用程序类。

MFCApplication1.cpp
    这是包含应用程序类 CMFMarchTrainApp 的主应用程序源文件。
...
MFCApplication1Dlg.h、MFCApplication1Dlg.cpp - 对话框
    这些文件包含 CMFMarchTrainDlg 类。此类定义应用程序的主对话框的行为。对话框模板包含在 MFCApplication1.rc 中，该文件可以在 Microsoft Visual C++ 中编辑。
